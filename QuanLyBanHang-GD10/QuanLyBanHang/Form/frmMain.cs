...
namespace QuanLyBanHang
{
    public partial class frmMain : Form
    {
        ...
        Reports.frmThongKeSanPham thongKeSanPham = null;
        Reports.frmThongKeDoanhThu thongKeDoanhThu = null;
        ...
        private void mnuThongKeSanPham_Click(object sender, EventArgs e)
        {
            ...
            {
                thongKeSanPham = new Reports.frmThongKeSanPham();
        ...
        private void mnuThongKeDoanhThu_Click(object sender, EventArgs e)
        {
            ...
            {
                thongKeDoanhThu = new Reports.frmThongKeDoanhThu();
        ...
        {
            MessageBox.Show("Phần mềm Quản lý bán hàng - Giai đoạn 10\nPhiên bản: 1.0.0\nTác giả: FIT - AGU", "Thông tin phần mềm", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
