...
namespace QuanLyBanHang.Reports
{
    public partial class frmInHoaDon : Form
    {
        ...
        private QLBHDataSet.DanhSachHoaDon_ChiTietDataTable danhSachHoaDon_ChiTietDataTable = new QLBHDataSet.DanhSachHoaDon_ChiTietDataTable();
        ...
        private void frmInHoaDon_Load(object sender, EventArgs e)
        {
            ...
            if (hoaDon != null)
            {
                var hoaDonChiTiet = context.HoaDon_ChiTiet.Where(r => r.HoaDonID == id).Select(r => new 
                {
                    ID = r.ID,
                    HoaDonID = r.HoaDonID,
